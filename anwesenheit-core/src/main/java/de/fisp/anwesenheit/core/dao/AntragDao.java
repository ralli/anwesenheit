...
public interface AntragDao {
   ...
   *
   * @param benutzerId Die BenutzerId zu der die Anträge gesucht werden sollen.
   ...
   *
   * @param id Die id des Antrags, der gelesen werden soll.
   ...
   *
   * @param benutzerId Der Benutzer, zu dem die Anträge gelesen werden sollen
   * @param filter     Das zusätzliche Filterkriterium
   * @return Die Liste der gefundenen Anträge
   */
   ...
   * Filters
   *
   * @param bewilligerId Der Benutzer, zu dem die Anträge gelesen werden sollen
   * @param filter       Das zusätzliche Filterkriterium
   * @return Die Liste der gefundenen Anträge
   */
   ...
   *
   * @param antrag Der zu speichernde Antrag.
   */
