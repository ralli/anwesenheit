...
public interface BerechtigungsService {
   ...
   * </ul>
   *
   * @param antrag   Der zu prüfende Antrag
   * @param benutzer Der zu prüfende Benutzer
   ...
   *
   * @param antrag     Der zu prüfende Antrag
   * @param benutzerId Die Id des zu prüfenden Benutzers
   * @return true, wenn der Antrag für den Benutzer sichtbar ist
   ...
   * </ul>
   *
   * @param currentBenutzerId Der Benutzer dessen Berechtigung geprüft wird
   * @param benutzerId        Der Benutzer dessen Anträge anzuzeigen sind.
   ...
   *
   * @param antrag     Der zu prüfende Antrag
   * @param benutzerId Der zu prüfende Benutzer
   * @return true, wenn die Prüfung zu einem positiven Ergebnis kommt
   * @throws de.fisp.anwesenheit.core.util.NotFoundException
   *          wenn der Benutzer nicht existiert
   */
   ...
   *
   * @param currentBenutzerId Der Benutzer, dessen Berechtigungen geprüft werden sollen
   * @param benutzerId        Der Benutzer, dessen Bewilligungen angesehen werden sollen
   ...
   *
   * @param benutzerId  Der zu prüfende Benutzer
   * @param bewilligung Die zu prüfende Bewilligung
   ...
   * Liefert true, wenn der Benutzer über Sonderberechtigungen verfügt
   *
   * @param benutzerId Die Benutzerkennung des Benutzers
   * @return true, wenn der Benutzer über Sonderberechtigungen verfügt
   * @throws de.fisp.anwesenheit.core.util.NotFoundException
   *          wenn der Benutzer nicht existiert
   */
