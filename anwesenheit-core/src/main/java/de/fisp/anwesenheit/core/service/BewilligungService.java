...
public interface BewilligungService {
   ...
   *
   * @param benutzerId    Der Benutzer der die Bewilligung löschen möchte
   * @param bewilligungId Die Bewilligung, die gelöscht werden soll
   ...
   *
   * @param benutzerId Der Benutzer, der die Bewilligung hinzufügen möchte
   * @param command    Die Daten der Bewilligung, die hinzugefügt werden soll
   * @return Die Bewilligungsdaten der neu hinzugefügten Bewilligung
   */
   ...
   * @param benutzerId    Die ID des Benutzers dessen Bewilligungen angezeigt werden sollen.
   ...
   *          wenn der Benutzer nicht gefunden wurde
   */
  BewilligungListe findByBenutzerAndFilter(String currentUserId, BewilligungsFilter filter);

  /**
   * Setzt den Status eines Urlaubsantrags
   *
   * @param benutzerId Die Benutzer-ID des Bewilligers
   * @param command    Die Angaben die Statusänderung
   * @throws de.fisp.anwesenheit.core.util.NotFoundException
   ...
   *
   * @param benutzerId    Der aktuell angemeldete Benutzer (zur Berechtigungsprüfung)
   * @param bewilligungId Die ID der Bewilligung
