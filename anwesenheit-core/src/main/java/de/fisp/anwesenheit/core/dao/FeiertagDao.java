...
public interface FeiertagDao {
   ...
   *
   * @param year Das Jahr zu dem die Feiertage gelesen werden sollen
   ...
   *
   * @param von Das Anfangsdatum (inklusive)
   * @param bis Das Enddatum (inklusive)
   * @return Die Liste der Feiertage
   */
   ...
   *
   * @param year Das Jahr in dem alle Feiertage gelöscht werden sollen
   */
   ...
   *
   * @param feiertag Der zu speichernde Feiertag
   */
   ...
   *
   * @param feiertag Der zu löschende Feiertag
   */
